...
function grey_t() {
	$('#t1').css({ 'background-color': '#8c91a7' }); $('#t2').css({ 'background-color': '#8c91a7' });$('#t3').css({ 'background-color': '#8c91a7' });
	$('#t4').css({ 'background-color': '#8c91a7' }); $('#t5').css({ 'background-color': '#8c91a7' });$('#t6').css({ 'background-color': '#8c91a7' });
}
...
$(document).ready(function () {
	...
	$('#t1').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				boy = 1;
				$('#minutos').text(0 + ":"); $('#segundos').text(30); contador_s = 30; contador_m = 0;
	...
	$('#t2').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				...
				//$('#han-tei').show("slow");
				boy = 0;
				valor = $('#t2').text()/60; $('#minutos').text(valor + ":"); $('#segundos').text('00');
				contador_s = 0; contador_m = valor; grey_t(); $(this).css({ 'background-color': '#b0710d' });
			}
		}
	})
	$('#t3').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				boy = 0;
				valor = Math.floor($('#t3').text()/60); $('#minutos').text(valor + ":"); $('#segundos').text($('#t3').text() - Math.floor($('#t3').text()/60) * 60);
				console.log(valor);
				contador_s = $('#t3').text() - Math.floor($('#t3').text()/60) * 60;contador_m = Math.floor($('#t3').text()/60); grey_t(); $(this).css({ 'background-color': '#b0710d' });
			}
		}
	})
	$('#t4').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				boy = 0;
				valor = Math.floor($('#t4').text()/60); $('#minutos').text(valor + ":"); $('#segundos').text('00');
				contador_s = $('#t4').text() - Math.floor($('#t4').text()/60) * 60; contador_m = Math.floor($('#t4').text()/60); grey_t(); $(this).css({ 'background-color': '#b0710d' });
			}
		}
	})
	$('#t5').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				boy = 0;
				valor = Math.floor($('#t5').text()/60); $('#minutos').text(valor + ":"); $('#segundos').text($('#t5').text() - Math.floor($('#t5').text()/60) * 60);
				contador_s = $('#t5').text() - Math.floor($('#t5').text()/60) * 60; contador_m = Math.floor($('#t5').text()/60); grey_t(); $(this).css({ 'background-color': '#b0710d' });
			}
		}
	})
	$('#t6').click(function () {
		if (running == 0) {
			...
			if (confirmar) {
				boy = 0;
				valor = Math.floor($('#t6').text()/60); $('#minutos').text(valor + ":"); $('#segundos').text('00');
				contador_s = $('#t6').text() - Math.floor($('#t6').text()/60) * 60; contador_m = Math.floor($('#t6').text()/60); grey_t(); $(this).css({ 'background-color': '#b0710d' });
			}
		}
	})
